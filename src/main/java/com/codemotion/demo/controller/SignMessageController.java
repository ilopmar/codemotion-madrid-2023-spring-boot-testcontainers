...
import com.codemotion.demo.MessageService;
import com.codemotion.demo.repository.MessageEntity;
import com.codemotion.demo.repository.MessageRepository;
...
class SignMessageController {
  ...
  @PostMapping
  public ResponseEntity<Void> createMessage(@RequestBody PlainMessage plainMessage) {
